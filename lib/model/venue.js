...
/**
* Our new() function so a new venue can be created.
*/
...
var obj = function(data) {
	this.data = data;
	this.num_seats = -1;
	log.info("Venue created. In real life, we'd read venue data from the database.");
}
...
obj.prototype.getNumSeats = function() {
	...
	//
	// First time here.  Calculate number of available seats.
	//
	this.num_seats = 0;
	var data = this.data;
...
*/
obj.prototype.lockSeat = function(section, row, seat) {
	...
	//
	// How many seconds before unlocking a seat.
	//
	var ttl = 600;
